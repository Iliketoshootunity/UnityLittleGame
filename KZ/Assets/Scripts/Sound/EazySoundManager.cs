...
namespace LFrameWork.Sound
{
    ...
    public class EazySoundManager : MonoBehaviour
    {
        ...
        public static int PlayUISound(AudioClip clip, float volume, bool persist)
        {
            return PlayAudio(Audio.AudioType.UISound, clip, volume, false, persist, 0f, 0f, -1f, null);
        }
        /// <summary>
        /// 播放音乐
        /// </summary>
